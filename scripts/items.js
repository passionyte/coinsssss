...
export const items = {
    ...
    upgrades: [
        ...
        new Upgrade("Million Dollar Click", "You're a millionaire! You already were. Base coins per click is multiplied by 16.", 2.5e8, {Stats: {CoinsPc: 63936}}, {CoinsPc: 16}),
        ...
        new Upgrade("Maxed Out Coins", "The cost is as much as the 32 bit limit! Base coins per click is multiplied by 32.", 2.147483648e9, {Stats: {CoinsPc: 1022976}}, {CoinsPc: 32}),
        ...
        new Upgrade("Ruby Mouse", "Told you Ruby was better than Bloodstone. Clickers are twice as efficient!", 2e10, { Structures: { Clicker: 300 } }, { Clicker: 2 }),
        ...
        new Upgrade("Infinite Luck", "Well technically your luck is finite, but I like to keep things 'creative' in this game. 8-Balls are twice as efficient!", 1e10, { Structures: { ["8-Ball"]: 200 } }, { ["8-Ball"]: 2 }),
        new Upgrade("Globalization", "Fun fact: 102% more people hate you now. Currencies are twice as efficient!", 1.7e10, { Structures: { Currency: 200 } }, { Currency: 2 }),
        new Upgrade("Neopolitan", "An absurdly expensive joke. The Matrixes are twice as efficient!", 7.9e12, { Structures: { ["The Matrix"]: 200 } }, { ["The Matrix"]: 2 }),
        ...
        new Upgrade("Lunar Implementation", "Lunar power is expensive. But why should you care? You are literally using star power to manipulate the fabric of reality. Atomizers are twice as efficient!", 1e14, { Structures: { Atomizer: 50 } }, { Atomizer: 2 }),
        new Upgrade("8-Ball Random Factor", "This is safe! Hey 8-Ball, should I destroy the universe? Matter Refiners are 3 times as efficient, 8-Balls are 88 times as efficient!", 8.89e10, { Structures: { ["Matter Refiner"]: 8, ["8-Ball"]: 88 } }, { ["Matter Refiner"]: 3, ["8-Ball"]: 88 }),
        new Upgrade("Atomizer Bundle", "Bundle a Atomizer with your stock! Atomizers are twice as efficient, Currencies are 60 times as efficient!", 4.8e12, { Structures: { Atomizer: 15, Currency: 75 } }, { Atomizer: 2, Currency: 60 }),
        new Upgrade("Compatibility", "Make your Atomizers compatible with your old Matter Refiners. Atomizers are twice as efficient, Matter Refiners are 8 times as efficient!", 8.5e13, { Structures: { Atomizer: 50, ["Matter Refiner"]: 100 } }, { Atomizer: 2, ["Matter Refiner"]: 8 }),
        new Upgrade("Fabric Manipulators", "No, not as in carpets.. the fabric of reality. Atomizers are twice as efficient!", 2.1e14, { Structures: { Atomizer: 100 } }, { Atomizer: 2 }),
